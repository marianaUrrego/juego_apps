...
const enemy06Url = new URL('../../assets/backgrounds/cementery/characters/Enemy 06-1.png', import.meta.url).href

export const enemy06Config: SpriteConfig = {
  imagePath: enemy06Url,
  frameWidth: 32,
  frameHeight: 32,
  rows: 4,
  cols: 3,
